...
class Settings(BaseSettings):
    ...
    BRIGHTDATA_TRIGGER_URL: str = "https://api.brightdata.com/datasets/v3/trigger"
    BRIGHTDATA_PROGRESS_URL: str = "https://api.brightdata.com/datasets/v3/progress"
    BRIGHTDATA_DOWNLOAD_URL: str = "https://api.brightdata.com/datasets/v3/snapshot"
